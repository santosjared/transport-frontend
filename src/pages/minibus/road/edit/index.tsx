...
const MapsEdit = ({ toggle, title, data, page, pageSize }: Props) => {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await dispatch(updateRoad({data:updatedata,id:data.id,filtrs:{skip: page * pageSize, limit: pageSize}}))
    ...
    <Card>
      ...
      <form onSubmit={onSubmit}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={4} sx={{ p: 3, ml: { xs: 3, sm: 0 } }}>
